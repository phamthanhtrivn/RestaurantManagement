...
public class CapNhatHoaDon_Admin_PN extends javax.swing.JPanel {
    ...
    private QuanLy_DashBoard dashBoard;
    private HoaDon hd;
     ...
     */
    public CapNhatHoaDon_Admin_PN(Ban ban, QuanLy_DashBoard dashBoard) {
        initComponents();
        this.ban = ban;
    ...
    public boolean deleteCTHD() {
        ...
        for (ChiTietHoaDon ct : list) {
            ...
            if (!map.containsKey(ct.getMonAn().getMaMA())) {
                ...
                result = cthd_dao.delete(new ChiTietHoaDon.ChiTietHoaDonId(new HoaDon(hd.getMaHD()), new MonAn(ct.getMonAn().getMaMA())));
                n++;
            }
        }
