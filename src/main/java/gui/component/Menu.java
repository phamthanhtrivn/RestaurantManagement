...
public class Menu extends javax.swing.JPanel {
    ...
    public void initMenuItemQuanLy() {
        ...
        addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/gui/icon/icons8-customers-32.png")), "Quản Lý Khách Hàng"));
        addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/gui/icon/icons8-employees-32.png")), "Quản Lý Nhân Viên"));
        addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/gui/icon/icons8-meal-32.png")), "Quản Lý Món Ăn"));
        addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/gui/icon/icons8-voucher-32.png")), "Quản Lý Khuyến Mãi"));        
        addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/gui/icon/icons8-table-32.png")), "Quản Lý Bàn"));
        addMenu(new ModelMenu(new ImageIcon(getClass().getResource("/gui/icon/icons8-chart-32.png")), "Thống Kê", "Doanh Thu", "Món Ăn"));
    }
